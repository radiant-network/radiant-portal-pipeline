...
ALTER TABLE radiant.snv__variant ADD COLUMN somatic_pf_tn_wgs DOUBLE AFTER germline_pf_wxs;
ALTER TABLE radiant.snv__variant ADD COLUMN somatic_pf_tn_wxs DOUBLE AFTER somatic_pf_tn_wgs;

ALTER TABLE radiant.snv__variant ADD COLUMN somatic_pc_tn_wgs INT(11) AFTER germline_pf_wxs_not_affected;
ALTER TABLE radiant.snv__variant ADD COLUMN somatic_pn_tn_wgs INT(11) AFTER somatic_pc_tn_wgs;
ALTER TABLE radiant.snv__variant ADD COLUMN somatic_pc_tn_wxs INT(11) AFTER somatic_pn_tn_wgs;
ALTER TABLE radiant.snv__variant ADD COLUMN somatic_pn_tn_wxs INT(11) AFTER somatic_pc_tn_wxs;

-- Variant table new columns
ALTER TABLE radiant.snv__variant_partitioned ADD COLUMN somatic_pf_tn_wgs DOUBLE AFTER germline_pf_wxs;
ALTER TABLE radiant.snv__variant_partitioned ADD COLUMN somatic_pf_tn_wxs DOUBLE AFTER somatic_pf_tn_wgs;

ALTER TABLE radiant.snv__variant_partitioned ADD COLUMN somatic_pc_tn_wgs INT(11) AFTER germline_pf_wxs_not_affected;
ALTER TABLE radiant.snv__variant_partitioned ADD COLUMN somatic_pn_tn_wgs INT(11) AFTER somatic_pc_tn_wgs;
ALTER TABLE radiant.snv__variant_partitioned ADD COLUMN somatic_pc_tn_wxs INT(11) AFTER somatic_pn_tn_wgs;
ALTER TABLE radiant.snv__variant_partitioned ADD COLUMN somatic_pn_tn_wxs INT(11) AFTER somatic_pc_tn_wxs;
...
UPDATE radiant.staging_sequencing_experiment SET histology_type = 'normal' WHERE histology_type IS NULL;
```