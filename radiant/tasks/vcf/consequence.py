...
SCHEMA = merge_schemas(
    ...
    Schema(
        ...
        NestedField(
            ...
            "exon",
            StructType(
                NestedField(211, "rank", IntegerType(), required=False),
                NestedField(212, "total", IntegerType(), required=False),
            ),
            required=False,
        ),
    ...
    if csq:
        ...
        for c in csq_data:
            ...
            consequence = {
                ...
                "exon": {"rank": int(exon[0]), "total": int(exon[1])} if len(exon) == 2 else None,
