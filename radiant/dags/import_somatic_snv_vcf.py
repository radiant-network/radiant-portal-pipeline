...
with DAG(
    dag_id=f"{NAMESPACE}-import-somatic-snv-vcf",
    default_args=default_args,
    start_date=days_ago(1),
    schedule_interval=None,
    tags=["radiant", "iceberg"],
    dag_display_name="Radiant - Import Somatic SNV VCF",
    catchup=False,
    params=dag_params,
    ...
    def create_parquet_files(case: dict, namespace: str):
        ...
        from radiant.tasks.vcf.experiment import Case
        from radiant.tasks.vcf.snv.somatic.process import process_case
