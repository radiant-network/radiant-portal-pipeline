INSERT INTO {{ mapping.starrocks_germline_snv_consequence }}
SELECT
    ...
    c.aa_change,
    c.dna_change
FROM {{ mapping.iceberg_consequence }} c
LEFT JOIN {{ mapping.starrocks_germline_snv_tmp_variant }} v ON c.locus_hash = v.locus_hash
