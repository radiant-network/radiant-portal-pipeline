...
def mock_results():
    return [
        [
            (1, "file_1.vcf", 1, "germline", 1, "cnv_1.vcf", "exomiser_1.tsv", 1, 1, "wgs", 1, "routine", "sample_1",
             "role_1", "M", "affected"),
            (1, "file_1.vcf", 1, "germline", 2, None, None, 2, 2, "wgs", 1, "routine", "sample_2", "role_2", "F",
             "not_affected"),
            (2, "file_2.vcf", 2, "germline", 3, "cnv_2.vcf", None, 3, 3, "wgs", 1, "routine", "sample_3", "role_3", "M",
             "affected"),
        ]
    ]
