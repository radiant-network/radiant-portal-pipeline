...
(
    ...
    PRIMARY KEY ("code", "tenant_code")
);

CREATE TABLE IF NOT EXISTS "patient"
(
    "id"                            INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "submitter_patient_id"       TEXT,
    "submitter_patient_id_type"  TEXT,
    ...
    "jhn"                           TEXT,
    "tenant_code"                   TEXT NOT NULL,
    CONSTRAINT unique_mrn_org UNIQUE ("submitter_patient_id", "organization_code"),
    FOREIGN KEY ("organization_code", "tenant_code") REFERENCES "organization" ("code", "tenant_code")
);
-- Cases ---------------------------------------------------------------
...
(
    ...
    FOREIGN KEY ("ordering_organization_code", "tenant_code") REFERENCES "organization" ("code", "tenant_code"),
    FOREIGN KEY ("diagnosis_lab_code", "tenant_code") REFERENCES "organization" ("code", "tenant_code")
);
...
(
    ...
    "tenant_code"                       TEXT NOT NULL,
    FOREIGN KEY ("sequencing_lab_code", "tenant_code") REFERENCES "organization" ("code", "tenant_code")
);
